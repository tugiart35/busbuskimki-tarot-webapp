...
Google size birkaç verification yöntemi sunar. **HTML Meta Tag** en kolay yöntemdir:
...
**Önemli:** Environment variables ekledikten sonra **Redeploy** yapmanız gerekir!
...
Tarayıcıda ana sayfayı açın ve **Sağ Tık → "View Page Source"** / "Kaynağı Görüntüle"
...
*Bu rehber, sitemap'inizi Google Search Console'a submit etmek için gereken tüm adımları içerir. Takıldığınız bir yer olursa, ilgili bölüme geri dönün.*
