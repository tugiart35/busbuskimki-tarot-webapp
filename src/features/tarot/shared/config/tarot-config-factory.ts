...
const createFormI18nKeys = (spreadId: string): FormI18nKeys => ({
  ...
  birthDateUnknown: `${spreadId}.form.birthDateUnknown`,
  relationshipStatus: `${spreadId}.form.relationshipStatus`,
  ...
  relationshipStatusOptions: {
    ...
    divorced: `${spreadId}.form.relationshipStatusOptions.divorced`,
