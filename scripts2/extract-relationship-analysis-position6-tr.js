...
const SPREAD_NAME = 'relationship-analysis'; // 'love', 'career', 'money', vb.
const POSITION_NUMBER = 6; // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-6-partnerinizin-beklentileri.ts'; // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`; // position2Meanings, vb.
const TYPE_NAME = `RelationshipAnalysisPositionMeaning`; // LovePosition1Meaning, vb.
