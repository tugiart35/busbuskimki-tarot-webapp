...
const SPREAD_NAME = 'problem-solving'; // 'love', 'career', 'money', vb.
const POSITION_NUMBER = 10; // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-9-korkular-endiseler.ts'; // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`; // position2Meanings, vb.
const TYPE_NAME = `ProblemSolvingPosition9Meaning`; // LovePosition1Meaning, vb.
