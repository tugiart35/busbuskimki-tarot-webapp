...
const FILE_NAME = 'position-5-yakin-gelecek.ts'; // position dosyasının adı
const ARRAY_NAME = `Position${POSITION_NUMBER}Meanings`; // Position5Meanings, vb.
const TYPE_NAME = `MoneyPosition5Meaning`; // moneyPosition1Meaning, vb.
