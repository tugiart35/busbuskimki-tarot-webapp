...
const SPREAD_NAME = 'situation-analysis'; // 'love', 'career', 'money', vb.
const POSITION_NUMBER = 7; // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-7-olasi-gelecek-sonuc.ts'; // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`; // position2Meanings, vb.
const TYPE_NAME = `SituationAnalysisPositionMeaning`; // LovePosition1Meaning, vb.
