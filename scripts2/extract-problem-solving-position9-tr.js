...
const POSITION_NUMBER = 9; // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-8-dis-etkeler.ts'; // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`; // position2Meanings, vb.
const TYPE_NAME = `ProblemSolvingPosition8Meaning`; // LovePosition1Meaning, vb.
