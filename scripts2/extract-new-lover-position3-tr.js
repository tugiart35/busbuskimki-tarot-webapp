...
const SPREAD_NAME = 'new-lover'; // 'love', 'career', 'money', vb.
const POSITION_NUMBER = 3; // 1, 2, 3, 4, vb.
const FILE_NAME = 'position-3-birbirimize-uyumlu-olabilecekmiyiz.ts'; // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`; // position2Meanings, vb.
const TYPE_NAME = `NewLoverposition3Meaning`; // LovePosition1Meaning, vb.
