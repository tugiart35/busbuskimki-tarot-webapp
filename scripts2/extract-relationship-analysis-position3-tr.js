...
const FILE_NAME = 'position-3-sizin-beklentileriniz.ts'; // position dosyasının adı
const ARRAY_NAME = `position${POSITION_NUMBER}Meanings`; // position2Meanings, vb.
const TYPE_NAME = `RelationshipAnalysisposition3Meaning`; // LovePosition1Meaning, vb.
