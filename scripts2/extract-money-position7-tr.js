...
const FILE_NAME = 'position-7-gelecek-para-planlari.ts'; // position dosyasının adı
const ARRAY_NAME = `Position${POSITION_NUMBER}Meanings`; // Position7Meanings, vb.
const TYPE_NAME = `MoneyPosition7Meaning`; // moneyPosition1Meaning, vb.
